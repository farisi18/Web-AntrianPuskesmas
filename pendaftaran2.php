...
$_SESSION['halaman'] = 'pendaftaran2.php';
...
<body style="padding:20px; font-family: 'Merriweather', serif; background-image:url('gambar/bg.jpg'); background-size:cover">
  ...
  <script>
    $(document).ready(function() {
      setInterval(function() {
        $("#belumdipanggil").load('belumdipanggil.php')
      }, 1000);
    });
  </script>
  ...
  $tampil = mysqli_query($konek, "select * from tabelantrian where panggil='' and huruf='B' order by idantrian asc");
